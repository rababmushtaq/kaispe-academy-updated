...
import Features from "../components/home-page/home-7/Features5";
...
const contact = () => {
  return (
    <>
      <Seo pageTitle="Purchase Requisition | Benefits" />
      ...
      {/* purchasefeature */}
      <div className="fancy-feature-seven pt-200 lg-pt-100 purchaseBenefit ">
        <div className="container " style={{marginTop:"150px"}}>
          <div className="row align-items-center">
            <div className="col-xl-12 col-lg-12" style={{marginTop:"-100px"}} data-aos="fade-right">
              <div className=" text-center text-lg-start">
                <h2 className="main-title fw-500 tx-dark m0" style={{color:"white", textAlign:"center"}}>
                Benefits of Purchase Requisition App for Businesses
                </h2>
                <p className="text-lg text-center text-lg-center md-pt-30 m0" style={{fontStyle:"italic", fontSize:"20px", color:"white"}}>
