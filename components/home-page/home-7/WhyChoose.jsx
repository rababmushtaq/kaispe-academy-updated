const WhyChoose = () => {
  const cards = [
    {
      iconSrc: "/images/softIcons/language.png",
      title: "Basic English language (spoken)",
    },
    {
      iconSrc: "/images/softIcons/email.png",
      title: "Professional email writing and ethics",
    },
    {
      iconSrc: "/images/softIcons/time.png",
